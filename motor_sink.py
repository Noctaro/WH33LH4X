...
docs/hardware.md#the-foreground-owns-the-motor. bridge.device.RawUsbWheel is the other: it
bypasses the Microsoft driver, and with it the gate. See evidence/RAW_USB.md.
